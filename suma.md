---
layout: default
title: IC Student Quiz - Suma
---

# Ejemplo de ejercicio: Suma
...
Representa los números naturales/enteros A= ... y B= ... con n=8 bits y calcula su suma (S). Puedes usar la fila C para anotar el acarreo (opcional).
</div>
{% endcapture %}

{% capture macro_formato_y_ejemplo %}
Formato de respuesta: <a href="https://webdiis.unizar.es/~luisma/ic/teclado_vector_suma2.html">vector de respuestas (generado por botones)</a> <b><u><a href="https://mglfcn.github.io/ic-student-quiz/kb/ic/teclado_vector_suma2.html">(vector)</a></u></b><br>
<table>
  <tr>
    <td style="padding: 15px 25px; vertical-align: top;">Ejemplo:</td>
    <td style="padding: 15px 25px; vertical-align: top;">011000001110SI</td>
  </tr>
</table><br>
{% endcapture %}
...
<select id="pagina" onchange="cargarPagina()">
 <option value="teclado_vector_suma2.html" data-w="500" data-h="450" data-h-movil="500">vector</option>
</select>
