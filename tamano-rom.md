---
layout: default
title: IC Student Quiz - Tamaño ROM
---

# Ejemplo de ejercicio: Tamaño ROM
...
Queremos diseñar ...<br>
¿Qué tamaño debe tener la ROM que guarde ... ?
</div>
{% endcapture %}

{% capture macro_formato_y_ejemplo %}
Formato de respuesta: <b><u><a href="https://atc.unizar.es/mkgen/mkgen.html#N4Ig5iBcIPQwBAJQPIFl4GcCWAvApvABQB2A+gO4D2ATgCYbwDr8ZARlgC4YCUAOsfwwcAhtQ7x4AXhYBXALbxeIAB5LZc-v2Lyp8ANoBGALQBOALp6ADKbMAqEABoQGKHpCXHIA54BMngD6eAMyeACyeAKwBngBsngDsngAc0U4mnsogZk60UCAo6Nj4RGRUdBiMbJw8ngDGUBzUMngAvkA">tamaño de una ROM (n_palabrasxn_bits) (ROM)</a></u></b><br>
<table>
  <tr>
    <td style="padding: 15px 25px; vertical-align: top;">Ejemplo:</td>
    <td style="padding: 15px 25px; vertical-align: top;">128x16 (ROM de 128 palabras de 16 bits)</td>
  </tr>
</table><br>
{% endcapture %}
...
<select id="pagina" onchange="cargarPagina()">
 <option value="teclado_ROM.html" data-w="450" data-h="400" data-h-movil="600">ROM</option>
</select>
