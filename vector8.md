---
layout: default
title: IC Student Quiz - Vector 8b
---

# Ejemplo de ejercicio: Vector de 8 bits
...
Representa ... en un sistema .... de 8 bits.
</div>
{% endcapture %}

{% capture macro_formato_y_ejemplo %}
Formato de respuesta: <b><u><a href="https://atc.unizar.es/mkgen/mkgen.html#N4Ig5iBcIPQwBADgLQCMCWAXeA3ApgMaYD2ATgDoB2AzpgIanYC88G2brWn7XHfWVDiwDaABgCMAXSrx4IADQhqUYSFEKQ4kJMUATKCBQd8RMhoJRMpAK54AvkA">vector de 8 bits (8b)</a></u></b><br>
<table>
  <tr>
    <td style="padding: 15px 25px; vertical-align: top;">Ejemplo:</td>
    <td style="padding: 15px 25px; vertical-align: top;">10010010</td>
  </tr>
</table><br>
{% endcapture %}
...
<select id="pagina" onchange="cargarPagina()">
 <option value="teclado_8b.html" data-w="400" data-h="250" data-h-movil="320">8b</option>
</select>
