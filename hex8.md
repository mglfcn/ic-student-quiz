---
layout: default
title: IC Student Quiz - Hexadecimal (8 dígitos)
---

# Ejemplo de ejercicio: Hexadecimal (8 dígitos)
...
Formato de respuesta: <b><u><a href="https://atc.unizar.es/mkgen/mkgen.html#N4Ig5iBcIPQwBADgLQBMCWZ0Bd4AsBTADwENUCBjdAWxIBt4A3S7AewCcAdAOwGdsS7XAF54AB3YEAZuiL5iAfQxh5RJZlXqVhNcs16dW-RsPKeE6bPijOIAAxFbPUxtEBtOwEYATAGYALACsAGwA7IgAnACCAEIAwgAiAKIAYgC6PPDwIAA0ILxQbvZEuSAAPqV2pZ6l3qW+pRV5-qWBpcGloY2liKURpVGlMd15caUJpUmlKSBpeahQICjKOKpklDT0TCwcpRRQ2OwArgQAvkA">vector de 8 dígitos hexadecimales (hex8)</a></u></b><br>
<table>
  <tr>
    <td style="padding: 15px 25px; vertical-align: top;">Ejemplos:</td>
    <td style="padding: 15px 25px; vertical-align: top;">0xF0230E51</td>
    <td style="padding: 15px 25px; vertical-align: top;">0x00010e50</td>
    <td style="padding: 15px 25px; vertical-align: top;">0x00110050</td>
  </tr>
</table><br>
{% endcapture %}
...
<select id="pagina" onchange="cargarPagina()">
 <option value="teclado_hex8.html" data-w="450" data-h="400" data-h-movil="600">hex8</option>
</select>
