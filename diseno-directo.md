---
layout: default
title: IC Student Quiz - Diseño directo
---

# Ejemplo de ejercicio: Diseño directo (codificando estados en one-hot)
...
Aplica el método de diseño directo (usando un bit por estado) y obtén la expresión (suma de productos) del bit ... del siguiente autómata.
</div>
{% endcapture %}
...
<table>
  <tr>
    ...
    <td style="padding: 15px 25px; vertical-align: top;">Q1·X+Q2·X'+Q0</td>
  </tr>
</table><br>
{% endcapture %}
...
<select id="pagina" onchange="cargarPagina()">
 <option value="teclado_sdp2.html" data-w="400" data-h="250" data-h-movil="320">sdp</option>
</select>
